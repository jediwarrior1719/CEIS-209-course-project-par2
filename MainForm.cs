...
namespace Johnston_CourseProject_Part2
{
    public partial class MainForm : Form
    {
        ...
        {
            // convert the ListBox items to a genaric list 
        ...
        private void EmployeesListBox_DoubleClick(object sender, EventArgs e)
        {
            ...
            // check to see if emp is salary or hourly object
            if(emp is Salary)
            {
            ...
            {
                MessageBox.Show("Error.Ivalid employee type found.");
